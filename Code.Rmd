...
adonis(pair.bray ~ Time + Treatment + Sex + Subj_ID,
  ...
  # Residuals = 0.31445
adonis(pair.bray ~ Time*Treatment*Sex, data=pair.sampdf, permutations=100)
  # Time: p-value = 0.009901, R2 = 0.25838
  # Treatment: p-value = 0.009901, R2 = 0.12309
  # Sex: p-value =  0.009901, R2 = 0.07370
  # Time:Treatment: p-value = 0.009901, R2 = 0.09180
  # Time:Sex: p-value = 0.00901, R2 = 0.05753
  # Treatment:Sex: p-value = 0.277228, R2 = 0.02191
  # Time:Treatment:Sex: p-value = 0.277228, R2= 0.02160
...
for(i in 1:nrow(stevia.simper.kw)){
  ...
  stevia.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(physeq.pair))[i,2], "-",
          data.frame(tax_table(physeq.pair))[i,3], "-",
          data.frame(tax_table(physeq.pair))[i,4], "-",
          data.frame(tax_table(physeq.pair))[i,5], "-",
          data.frame(tax_table(physeq.pair))[i,6])
}
...
stevia.pre.simper.kw <- read.csv("Simper_OTU/stevia.pre_krusk_simper.csv")
...
stevia.post.simper.kw <- read.csv("Simper_OTU/stevia.post_krusk_simper.csv")
...
stevia.hf.simper.kw <- read.csv("Simper_OTU/stevia.hf_krusk_simper.csv")
...
stevia.lf.simper.kw <- read.csv("Simper_OTU/stevia.lf_krusk_simper.csv")
...
stevia.sc.simper.kw <- read.csv("Simper_OTU/stevia.sc_krusk_simper.csv")
...
stevia.tv.simper.kw <- read.csv("Simper_OTU/stevia.tv_krusk_simper.csv")
...
#               c("Treatment", "Sex"),
#               perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
#               output_name='stevia.post.rem')
# stevia.post.simper <- read.csv("stevia.post.rem_clean_simper.csv")
...
# stevia.post.rem.simper.kw <- read.csv("stevia.post.rem_krusk_simper.csv")
...
#     paste(data.frame(tax_table(physeq.post.rem))[i,2], "-",
#           data.frame(tax_table(physeq.post.rem))[i,3], "-",
#           data.frame(tax_table(physeq.post.rem))[i,4], "-",
#           data.frame(tax_table(physeq.post.rem))[i,5], "-",
#           data.frame(tax_table(physeq.post.rem))[i,6])
# }
#write.table(stevia.post.simper.kw, "stevia.post.rem_krusk_simper.csv", sep=",")
...
# Remove any genla with <0.1% rel abund
gen99 <- prune_taxa(taxa_sums(gen99) > 0.01, gen99)
...
for(i in 1:nrow(stevia.simper.kw)){
  ...
  stevia.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(gen99))[i,2], "-",
          data.frame(tax_table(gen99))[i,3], "-",
          data.frame(tax_table(gen99))[i,4], "-",
          data.frame(tax_table(gen99))[i,5], "-",
          data.frame(tax_table(gen99))[i,6])
}
...
stevia.genus.post.simper.kw <- read.csv("stevia.genus.post_krusk_simper.csv")
...
for(i in 1:nrow(stevia.genus.hf.simper.kw)){
  ...
  stevia.genus.hf.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(gen99, Treatment == "High Fat")))[i,2], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "High Fat")))[i,3], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "High Fat")))[i,4], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "High Fat")))[i,5], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "High Fat")))[i,6])
}
...
for(i in 1:nrow(stevia.genus.lf.simper.kw)){
  ...
  stevia.genus.lf.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(gen99, Treatment == "Low Fat")))[i,2], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Low Fat")))[i,3], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Low Fat")))[i,4], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Low Fat")))[i,5], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Low Fat")))[i,6])
}
...
for(i in 1:nrow(stevia.genus.sc.simper.kw)){
  ...
  stevia.genus.sc.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(gen99, Treatment == "Saccharin")))[i,2], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Saccharin")))[i,3], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Saccharin")))[i,4], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Saccharin")))[i,5], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Saccharin")))[i,6])
}
...
for(i in 1:nrow(stevia.genus.tv.simper.kw)){
  ...
  stevia.genus.tv.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(gen99, Treatment == "Stevia")))[i,2], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Stevia")))[i,3], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Stevia")))[i,4], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Stevia")))[i,5], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Stevia")))[i,6])
}
