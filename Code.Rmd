...
tax_table(physeq.simper.post)$OTU_Classification <- ordered(tax_table(physeq.simper.post)$OTU_Classification, levels=c("Akkermansia", "Anaeroplasma", "Lactobacillus", "Lactococcus", "Lachnospiraceae", "Ruminiclostridium", "Alistipes", "S24-7", "S24-7", "S24-7", "Bacteroides"))
...
plot_heatmap(physeq.simper.post, sample.label = "Treatment", sample.order = c("LowFat", "HighFat", "Saccharin", "Stevia"), taxa.label = "OTU_Classification", taxa.order = "Phylum", low = "#FFFFCC", high = "firebrick3", na.value = "#FFFFFC") +
