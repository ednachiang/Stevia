...
stevia.post.simper.kw <- read.csv("Simper_OTU/stevia.post_treat_krusk_simper.csv")
...
write.table(stevia.post.simper.kw, "Simper_OTU/stevia.post_treat_krusk_simper.csv", sep=",")
