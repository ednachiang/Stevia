...
simper.post.fem.treat <- read.csv("Simper_OTU_post_fem.csv")
...
simper.post.fem.treat.hm <- simper.post.fem.treat.hm[,-5:-7]
...
simper.post.mal.treat <- read.csv("Simper_OTU_post_mal.csv")
...
simper.post.mal.treat.hm <- simper.post.mal.treat.hm[,-5:-7]
...
post.fem.hm <- plot_heatmap(physeq.simper.post.fem, sample.label = "Treatment", sample.order = c("LowFat", "HighFat", "Saccharin", "Stevia"), taxa.label = "OTU_Classification", taxa.order = "Phylum", low = "#FFFFCC", high = "firebrick3", na.value = "#FFFFFC") +
...
post.mal.hm <- plot_heatmap(physeq.simper.post.mal, sample.label = "Treatment", sample.order = c("LowFat", "HighFat", "Saccharin", "Stevia"), taxa.label = "OTU_Classification", taxa.order = "Phylum", low = "#FFFFCC", high = "firebrick3", na.value = "#FFFFFC") +
  geom_tile(colour="gray40") +
  #geom_text(aes(label=sprintf("%0.2f", round(Abundance, digits=2)))) +
  scale_fill_gradient(name="Relative Abundance (%)", low = "#FFFFCC", high = "firebrick3") +
  scale_x_discrete(labels = c("Low Fat", "High Fat", "Saccharin", "Stevia")) +
...
physeq.simper.time.fem <- subset_taxa(physeq.pair, Species == "Otu00002" | Species == "Otu00006" | 
                                      Spcies == "Otu00007" | Species == "Otu00008" | Species == "Otu00010" | 
...
simper.time.fem.treat <- read.csv("Simper_OTU_time_fem.csv")
...
simper.time.fem.treat.hm <- simper.time.fem.treat.hm[,-9:-11]
simper.time.fem.sampdat <- data.frame(c("LF_Pre", "LF_Post", "HF_Pre", "HF_Post", "SC_Pre", "SC_Post", "TV_Pre", "TV_Post"))
...
sample_data(physeq.simper.time.fem)$Treatment_Time <- ordered(sample_data(physeq.simper.time.fem)$Treatment_Time, levels=c("LF_Pre", "LF_Post", "HF_Pre", "HF_Post", "SC_Pre", "SC_Post", "TV_Pre", "TV_Post"))
...
simper.time.mal.treat <- read.csv("Simper_OTU_time_mal.csv")
...
simper.time.mal.treat.hm <- simper.time.mal.treat.hm[,-9:-11]
simper.time.mal.sampdat <- data.frame(c("LF_Pre", "LF_Post", "HF_Pre", "HF_Post", "SC_Pre", "SC_Post", "TV_Pre", "TV_Post"))
...
sample_data(physeq.simper.time.mal)$Treatment_Time <- ordered(sample_data(physeq.simper.time.mal)$Treatment_Time, levels=c("LF_Pre", "LF_Post", "HF_Pre", "HF_Post", "SC_Pre", "SC_Post", "TV_Pre", "TV_Post"))
...
# http://www.roymfrancis.com/a-guide-to-elegant-tiled-heatmaps-in-r/
# https://github.com/tidyverse/ggplot2/pull/2541
time.fem.hm <- plot_heatmap(physeq.simper.time.fem, sample.label = "Treatment_Time", sample.order = c("LF_Pre", "LF_Post", "HF_Pre", "HF_Post", "SC_Pre", "SC_Post", "TV_Pre", "TV_Post"), taxa.label = "OTU_Classification", taxa.order = "Phylum", low = "#FFFFCC", high = "firebrick3", na.value = "#FFFFFC") +
  geom_tile(colour="gray40") +
  #geom_text(aes(label=sprintf("%0.2f", round(Abundance, digits=2)))) +
...
time.mal.hm <- plot_heatmap(physeq.simper.time.mal, sample.label = "Treatment_Time", sample.order = c("LF_Pre", "LF_Post", "HF_Pre", "HF_Post", "SC_Pre", "SC_Post", "TV_Pre", "TV_Post"), taxa.label = "OTU_Classification", taxa.order = "Phylum", low = "#FFFFCC", high = "firebrick3", na.value = "#FFFFFC") +
  geom_tile(colour="gray40") +
  #geom_text(aes(label=sprintf("%0.2f", round(Abundance, digits=2)))) +
  scale_fill_gradient(name="Relative Abundance (%)", low = "#FFFFCC", high = "firebrick3", limits=c(0,12)) +
  scale_x_discrete(labels = c("Low Fat Pre", "Low Fat Post", "High Fat Pre", "High Fat Post",
