...
time.hm <- plot_heatmap(physeq.simper.time, sample.label = "Treatment_Time", sample.order = c("LF_Pre", "LF_Post", "HF_Pre", "HF_Post", "SC_Pre", "SC_Post", "TV_Pre", "TV_Post"), taxa.label = "OTU_Classification", taxa.order = "Phylum", low = "#FFFFCC", high = "firebrick3", na.value = "#FFFFFC") +
  ...
  scale_y_discrete(labels=c(expression(" "^a~"Bacteroides"), expression(" "^bcd~"S24-7"), 
                            ...
                            expression(" "^d~"Lactococcus"), expression(" "^abcd~"NK4A136"),
...
### Genus-Level
# Merge samples with the same taxonomic rank
goodgen <- tax_glom(physeq.pair, taxrank="Genus")

# Transform each merged genus count to rel abund
gen99 <- transform_sample_counts(goodgen, function(x){(x/sum(x))*100})

# Remove any genera with <0.1% rel abund
gen99 <- prune_taxa(taxa_sums(gen99) > 0.1, gen99)

# All
simper.pretty(data.frame(otu_table(gen99)),
              data.frame(sample_data(gen99)),
              c("Treatment", "Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.genus')
stevia.simper <- read.csv("stevia.genus_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(gen99)),
               data.frame(sample_data(gen99)),
               csv = stevia.simper,
               c("Treatment", "Time", "Sex"),
               output_name = 'stevia.genus',
               taxonomy = data.frame(tax_table(gen99)))
stevia.simper.kw <- read.csv("stevia.genus_krusk_simper.csv")
for(i in 1:nrow(stevia.simper.kw)){
  save <- which(rownames(data.frame(tax_table(gen99))) == stevia.simper.kw$OTU[i])
  stevia.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(gen99))[save,2], "-",
          data.frame(tax_table(gen99))[save,3], "-",
          data.frame(tax_table(gen99))[save,4], "-",
          data.frame(tax_table(gen99))[save,5], "-",
          data.frame(tax_table(gen99))[save,6])
}
#write.table(stevia.simper.kw, "stevia.genus_krusk_simper.csv", sep=",")

# Pre-treatment
simper.pretty(data.frame(otu_table(subset_samples(gen99, Time == "Pre-treatment"))),
              data.frame(sample_data(subset_samples(gen99, Time == "Pre-treatment"))),
              c("Treatment", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.genus.pre')
stevia.genus.pre.simper <- read.csv("stevia.genus.pre_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(gen99, Time == "Pre-treatment"))),
               data.frame(sample_data(subset_samples(gen99, Time == "Pre-treatment"))),
               csv = stevia.genus.pre.simper,
               c("Treatment", "Sex"),
               output_name = 'stevia.genus.pre',
               taxonomy = data.frame(tax_table(physeq.pre)))
stevia.genus.pre.simper.kw <- read.csv("stevia.genus.pre_krusk_simper.csv")
for(i in 1:nrow(stevia.genus.pre.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(gen99, Time == "Pre-treatment")))) == stevia.genus.pre.simper.kw$OTU[i])
  stevia.genus.pre.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(gen99))[save,2], "-",
          data.frame(tax_table(gen99))[save,3], "-",
          data.frame(tax_table(gen99))[save,4], "-",
          data.frame(tax_table(gen99))[save,5], "-",
...
#write.table(stevia.genus.pre.simper.kw, "stevia.genus.pre_krusk_simper.csv", sep=",")

# Post-treatment
simper.pretty(data.frame(otu_table(subset_samples(gen99, Time == "Post-treatment"))),
              data.frame(sample_data(subset_samples(gen99, Time == "Post-treatment"))),
              c("Treatment", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.genus.post')
stevia.genus.post.simper <- read.csv("stevia.genus.post_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(gen99, Time == "Post-treatment"))),
               data.frame(sample_data(subset_samples(gen99, Time == "Post-treatment"))),
               csv = stevia.genus.post.simper,
               c("Treatment", "Sex"),
               output_name = 'stevia.genus.post',
               taxonomy = data.frame(tax_table(subset_samples(gen99, Time == "Post-treatment"))))
stevia.genus.post.simper.kw <- read.csv("Simper_Genus/stevia.genus.post_krusk_simper.csv")
for(i in 1:nrow(stevia.genus.post.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(gen99, Time == "Post-treatment")))) == stevia.genus.post.simper.kw$OTU[i])
  stevia.genus.post.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(gen99))[save,2], "-",
          data.frame(tax_table(gen99))[save,3], "-",
          data.frame(tax_table(gen99))[save,4], "-",
          data.frame(tax_table(gen99))[save,5], "-",
...
#write.table(stevia.genus.post.simper.kw, "stevia.genus.post_krusk_simper.csv", sep=",")

# High Fat
simper.pretty(data.frame(otu_table(subset_samples(gen99, Treatment == "High Fat"))),
              data.frame(sample_data(subset_samples(gen99, Treatment == "High Fat"))),
              c("Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.genus.hf')
stevia.genus.hf.simper <- read.csv("stevia.genus.hf_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(gen99, Treatment == "High Fat"))),
               data.frame(sample_data(subset_samples(gen99, Treatment == "High Fat"))),
               csv = stevia.genus.hf.simper,
               c("Time", "Sex"),
               output_name = 'stevia.genus.hf',
               taxonomy = data.frame(tax_table(subset_samples(gen99, Treatment == "High Fat"))))
stevia.genus.hf.simper.kw <- read.csv("stevia.genus.hf_krusk_simper.csv")
for(i in 1:nrow(stevia.genus.hf.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(gen99, Treatment == "High Fat")))) == stevia.genus.hf.simper.kw$OTU[i])
  stevia.genus.hf.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(gen99, Treatment == "High Fat")))[save,2], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "High Fat")))[save,3], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "High Fat")))[save,4], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "High Fat")))[save,5], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "High Fat")))[save,6])
}
#write.table(stevia.genus.hf.simper.kw, "stevia.genus.hf_krusk_simper.csv", sep=",")

# Low Fat
simper.pretty(data.frame(otu_table(subset_samples(gen99, Treatment == "Low Fat"))),
              data.frame(sample_data(subset_samples(gen99, Treatment == "Low Fat"))),
              c("Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.genus.lf')
stevia.genus.lf.simper <- read.csv("stevia.genus.lf_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(gen99, Treatment == "Low Fat"))),
               data.frame(sample_data(subset_samples(gen99, Treatment == "Low Fat"))),
               csv = stevia.genus.lf.simper,
               c("Time", "Sex"),
               output_name = 'stevia.genus.lf',
               taxonomy = data.frame(tax_table(subset_samples(gen99, Treatment == "Low Fat"))))
stevia.genus.lf.simper.kw <- read.csv("stevia.genus.lf_krusk_simper.csv")
for(i in 1:nrow(stevia.genus.lf.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(gen99, Treatment == "Low Fat")))) == stevia.genus.lf.simper.kw$OTU[i])
  stevia.genus.lf.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(gen99, Treatment == "Low Fat")))[save,2], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Low Fat")))[save,3], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Low Fat")))[save,4], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Low Fat")))[save,5], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Low Fat")))[save,6])
}
#write.table(stevia.genus.lf.simper.kw, "stevia.genus.lf_krusk_simper.csv", sep=",")

# Saccharin
simper.pretty(data.frame(otu_table(subset_samples(gen99, Treatment == "Saccharin"))),
              data.frame(sample_data(subset_samples(gen99, Treatment == "Saccharin"))),
              c("Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.genus.sc')
stevia.genus.sc.simper <- read.csv("stevia.genus.sc_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(gen99, Treatment == "Saccharin"))),
               data.frame(sample_data(subset_samples(gen99, Treatment == "Saccharin"))),
               csv = stevia.genus.sc.simper,
               c("Time", "Sex"),
               output_name = 'stevia.genus.sc',
               taxonomy = data.frame(tax_table(subset_samples(gen99, Treatment == "Saccharin"))))
stevia.genus.sc.simper.kw <- read.csv("stevia.genus.sc_krusk_simper.csv")
for(i in 1:nrow(stevia.genus.sc.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(gen99, Treatment == "Saccharin")))) == stevia.genus.sc.simper.kw$OTU[i])
  stevia.genus.sc.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(gen99, Treatment == "Saccharin")))[save,2], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Saccharin")))[save,3], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Saccharin")))[save,4], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Saccharin")))[save,5], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Saccharin")))[save,6])
}
#write.table(stevia.genus.sc.simper.kw, "stevia.genus.sc_krusk_simper.csv", sep=",")

# Stevia
simper.pretty(data.frame(otu_table(subset_samples(gen99, Treatment == "Stevia"))),
              data.frame(sample_data(subset_samples(gen99, Treatment == "Stevia"))),
              c("Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.genus.tv')
stevia.genus.tv.simper <- read.csv("stevia.genus.tv_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(gen99, Treatment == "Stevia"))),
               data.frame(sample_data(subset_samples(gen99, Treatment == "Stevia"))),
               csv = stevia.genus.tv.simper,
               c("Time", "Sex"),
               output_name = 'stevia.genus.tv',
               taxonomy = data.frame(tax_table(subset_samples(gen99, Treatment == "Stevia"))))
stevia.genus.tv.simper.kw <- read.csv("stevia.genus.tv_krusk_simper.csv")
for(i in 1:nrow(stevia.genus.tv.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(gen99, Treatment == "Stevia")))) == stevia.genus.tv.simper.kw$OTU[i])
  stevia.genus.tv.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(gen99, Treatment == "Stevia")))[save,2], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Stevia")))[save,3], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Stevia")))[save,4], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Stevia")))[save,5], "-",
          data.frame(tax_table(subset_samples(gen99, Treatment == "Stevia")))[save,6])
}
#write.table(stevia.genus.tv.simper.kw, "stevia.genus.tv_krusk_simper.csv", sep=",")
```
...
# Transform each merged family count to rel abund
fam99 <- transform_sample_counts(goodfam, function(x){(x/sum(x))*100})

# Remove any phyla with <0.1% rel abund
fam99 <- prune_taxa(taxa_sums(fam99) > 0.01, fam99)

# All
simper.pretty(data.frame(otu_table(fam99)),
              data.frame(sample_data(fam99)),
              c("Treatment", "Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.family')
stevia.simper <- read.csv("stevia.family_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(fam99)),
               data.frame(sample_data(fam99)),
               csv = stevia.simper,
               c("Treatment", "Time", "Sex"),
               output_name = 'stevia.family',
               taxonomy = data.frame(tax_table(fam99)))
stevia.simper.kw <- read.csv("stevia.family_krusk_simper.csv")
for(i in 1:nrow(stevia.simper.kw)){
  save <- which(rownames(data.frame(tax_table(fam99))) == stevia.simper.kw$OTU[i])
  stevia.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(fam99))[i,2], "-",
          data.frame(tax_table(fam99))[i,3], "-",
          data.frame(tax_table(fam99))[i,4], "-",
          data.frame(tax_table(fam99))[i,5], "-",
          data.frame(tax_table(fam99))[i,6])
}
#write.table(stevia.simper.kw, "stevia.family_krusk_simper.csv", sep=",")

# Pre-treatment
simper.pretty(data.frame(otu_table(subset_samples(fam99, Time == "Pre-treatment"))),
              data.frame(sample_data(subset_samples(fam99, Time == "Pre-treatment"))),
              c("Treatment", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.family.pre')
stevia.family.pre.simper <- read.csv("stevia.family.pre_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(fam99, Time == "Pre-treatment"))),
               data.frame(sample_data(subset_samples(fam99, Time == "Pre-treatment"))),
               csv = stevia.family.pre.simper,
               c("Treatment", "Sex"),
               output_name = 'stevia.family.pre',
               taxonomy = data.frame(tax_table(physeq.pre)))
stevia.family.pre.simper.kw <- read.csv("stevia.family.pre_krusk_simper.csv")
for(i in 1:nrow(stevia.family.pre.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(fam99, Time == "Pre-treatment")))) == stevia.family.pre.simper.kw$OTU[i])
  stevia.family.pre.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(physeq.pre))[i,2], "-",
          data.frame(tax_table(physeq.pre))[i,3], "-",
          data.frame(tax_table(physeq.pre))[i,4], "-",
          data.frame(tax_table(physeq.pre))[i,5], "-",
...
#write.table(stevia.family.pre.simper.kw, "stevia.family.pre_krusk_simper.csv", sep=",")

# Post-treatment
simper.pretty(data.frame(otu_table(subset_samples(fam99, Time == "Post-treatment"))),
              data.frame(sample_data(subset_samples(fam99, Time == "Post-treatment"))),
              c("Treatment", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.family.post')
stevia.family.post.simper <- read.csv("stevia.family.post_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(fam99, Time == "Post-treatment"))),
               data.frame(sample_data(subset_samples(fam99, Time == "Post-treatment"))),
               csv = stevia.family.post.simper,
               c("Treatment", "Sex"),
               output_name = 'stevia.family.post',
               taxonomy = data.frame(tax_table(subset_samples(fam99, Time == "Post-treatment"))))
stevia.family.post.simper.kw <- read.csv("stevia.family.post_krusk_simper.csv")
for(i in 1:nrow(stevia.family.post.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(fam99, Time == "Post-treatment")))) == stevia.family.post.simper.kw$OTU[i])
  stevia.family.post.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(physeq.post))[i,2], "-",
          data.frame(tax_table(physeq.post))[i,3], "-",
          data.frame(tax_table(physeq.post))[i,4], "-",
          data.frame(tax_table(physeq.post))[i,5], "-",
...
#write.table(stevia.family.post.simper.kw, "stevia.family.post_krusk_simper.csv", sep=",")

# High Fat
simper.pretty(data.frame(otu_table(subset_samples(fam99, Treatment == "High Fat"))),
              data.frame(sample_data(subset_samples(fam99, Treatment == "High Fat"))),
              c("Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.family.hf')
stevia.family.hf.simper <- read.csv("stevia.family.hf_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(fam99, Treatment == "High Fat"))),
               data.frame(sample_data(subset_samples(fam99, Treatment == "High Fat"))),
               csv = stevia.family.hf.simper,
               c("Time", "Sex"),
               output_name = 'stevia.family.hf',
               taxonomy = data.frame(tax_table(subset_samples(fam99, Treatment == "High Fat"))))
stevia.family.hf.simper.kw <- read.csv("stevia.family.hf_krusk_simper.csv")
for(i in 1:nrow(stevia.family.hf.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(fam99, Treatment == "High Fat")))) == stevia.family.hf.simper.kw$OTU[i])
  stevia.family.hf.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(fam99, Treatment == "High Fat")))[i,2], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "High Fat")))[i,3], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "High Fat")))[i,4], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "High Fat")))[i,5], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "High Fat")))[i,6])
}
#write.table(stevia.family.hf.simper.kw, "stevia.family.hf_krusk_simper.csv", sep=",")

# Low Fat
simper.pretty(data.frame(otu_table(subset_samples(fam99, Treatment == "Low Fat"))),
              data.frame(sample_data(subset_samples(fam99, Treatment == "Low Fat"))),
              c("Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.family.lf')
stevia.family.lf.simper <- read.csv("stevia.family.lf_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(fam99, Treatment == "Low Fat"))),
               data.frame(sample_data(subset_samples(fam99, Treatment == "Low Fat"))),
               csv = stevia.family.lf.simper,
               c("Time", "Sex"),
               output_name = 'stevia.family.lf',
               taxonomy = data.frame(tax_table(subset_samples(fam99, Treatment == "Low Fat"))))
stevia.family.lf.simper.kw <- read.csv("stevia.family.lf_krusk_simper.csv")
for(i in 1:nrow(stevia.family.lf.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(fam99, Treatment == "Low Fat")))) == stevia.family.lf.simper.kw$OTU[i])
  stevia.family.lf.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(fam99, Treatment == "Low Fat")))[i,2], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "Low Fat")))[i,3], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "Low Fat")))[i,4], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "Low Fat")))[i,5], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "Low Fat")))[i,6])
}
#write.table(stevia.family.lf.simper.kw, "stevia.family.lf_krusk_simper.csv", sep=",")

# Saccharin
simper.pretty(data.frame(otu_table(subset_samples(fam99, Treatment == "Saccharin"))),
              data.frame(sample_data(subset_samples(fam99, Treatment == "Saccharin"))),
              c("Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.family.sc')
stevia.family.sc.simper <- read.csv("stevia.family.sc_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(fam99, Treatment == "Saccharin"))),
               data.frame(sample_data(subset_samples(fam99, Treatment == "Saccharin"))),
               csv = stevia.family.sc.simper,
               c("Time", "Sex"),
               output_name = 'stevia.family.sc',
               taxonomy = data.frame(tax_table(subset_samples(fam99, Treatment == "Saccharin"))))
stevia.family.sc.simper.kw <- read.csv("stevia.family.sc_krusk_simper.csv")
for(i in 1:nrow(stevia.family.sc.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(fam99, Treatment == "Saccharin")))) == stevia.family.sc.simper.kw$OTU[i])
  stevia.family.sc.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(fam99, Treatment == "Saccharin")))[i,2], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "Saccharin")))[i,3], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "Saccharin")))[i,4], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "Saccharin")))[i,5], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "Saccharin")))[i,6])
}
#write.table(stevia.family.sc.simper.kw, "stevia.family.sc_krusk_simper.csv", sep=",")

# Stevia
simper.pretty(data.frame(otu_table(subset_samples(fam99, Treatment == "Stevia"))),
              data.frame(sample_data(subset_samples(fam99, Treatment == "Stevia"))),
              c("Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.family.tv')
stevia.family.tv.simper <- read.csv("stevia.family.tv_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(fam99, Treatment == "Stevia"))),
               data.frame(sample_data(subset_samples(fam99, Treatment == "Stevia"))),
               csv = stevia.family.tv.simper,
               c("Time", "Sex"),
               output_name = 'stevia.family.tv',
               taxonomy = data.frame(tax_table(subset_samples(fam99, Treatment == "Stevia"))))
stevia.family.tv.simper.kw <- read.csv("stevia.family.tv_krusk_simper.csv")
for(i in 1:nrow(stevia.family.tv.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(fam99, Treatment == "Stevia")))) == stevia.family.tv.simper.kw$OTU[i])
  stevia.family.tv.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(fam99, Treatment == "Stevia")))[i,2], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "Stevia")))[i,3], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "Stevia")))[i,4], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "Stevia")))[i,5], "-",
          data.frame(tax_table(subset_samples(fam99, Treatment == "Stevia")))[i,6])
}
#write.table(stevia.family.tv.simper.kw, "stevia.family.tv_krusk_simper.csv", sep=",")

### BH CORRECTION FOR ALL OTU-LEVEL SIMPER COMPARISONS
stevia.simper.kw$Group <- rep("All", nrow(stevia.simper.kw))
stevia.simper.kw$OTU <- as.character(stevia.simper.kw$OTU)
stevia.simper.kw$Comparison <- as.character(stevia.simper.kw$Comparison)
stevia.family.pre.simper.kw$Group <- rep("Pre", nrow(stevia.family.pre.simper.kw))
stevia.family.pre.simper.kw$OTU <- as.character(stevia.family.pre.simper.kw$OTU)
stevia.family.pre.simper.kw$Comparison <- as.character(stevia.family.pre.simper.kw$Comparison)
stevia.family.post.simper.kw$Group <- rep("Post", nrow(stevia.family.post.simper.kw))
stevia.family.post.simper.kw$OTU <- as.character(stevia.family.post.simper.kw$OTU)
stevia.family.post.simper.kw$Comparison <- as.character(stevia.family.post.simper.kw$Comparison)
stevia.family.hf.simper.kw$Group <- rep("High Fat", nrow(stevia.family.hf.simper.kw))
stevia.family.hf.simper.kw$OTU <- as.character(stevia.family.hf.simper.kw$OTU)
stevia.family.hf.simper.kw$Comparison <- as.character(stevia.family.hf.simper.kw$Comparison)
stevia.family.lf.simper.kw$Group <- rep("Low Fat", nrow(stevia.family.lf.simper.kw))
stevia.family.lf.simper.kw$OTU <- as.character(stevia.family.lf.simper.kw$OTU)
stevia.family.lf.simper.kw$Comparison <- as.character(stevia.family.lf.simper.kw$Comparison)
stevia.family.sc.simper.kw$Group <- rep("Saccharin", nrow(stevia.family.sc.simper.kw))
stevia.family.sc.simper.kw$OTU <- as.character(stevia.family.sc.simper.kw$OTU)
stevia.family.sc.simper.kw$Comparison <- as.character(stevia.family.sc.simper.kw$Comparison)
stevia.family.tv.simper.kw$Group <- rep("Stevia", nrow(stevia.family.tv.simper.kw))
stevia.family.tv.simper.kw$OTU <- as.character(stevia.family.tv.simper.kw$OTU)
stevia.family.tv.simper.kw$Comparison <- as.character(stevia.family.tv.simper.kw$Comparison)
stevia.family.simper.all <- stevia.simper.kw
stevia.family.simper.all[(nrow(stevia.family.simper.all)+1):(nrow(stevia.family.simper.all)+nrow(stevia.family.pre.simper.kw)),] <- stevia.family.pre.simper.kw
stevia.family.simper.all[(nrow(stevia.family.simper.all)+1):(nrow(stevia.family.simper.all)+nrow(stevia.family.post.simper.kw)),] <- stevia.family.post.simper.kw
stevia.family.simper.all[(nrow(stevia.family.simper.all)+1):(nrow(stevia.family.simper.all)+nrow(stevia.family.hf.simper.kw)),] <- stevia.family.hf.simper.kw
stevia.family.simper.all[(nrow(stevia.family.simper.all)+1):(nrow(stevia.family.simper.all)+nrow(stevia.family.lf.simper.kw)),] <- stevia.family.lf.simper.kw
stevia.family.simper.all[(nrow(stevia.family.simper.all)+1):(nrow(stevia.family.simper.all)+nrow(stevia.family.sc.simper.kw)),] <- stevia.family.sc.simper.kw
stevia.family.simper.all[(nrow(stevia.family.simper.all)+1):(nrow(stevia.family.simper.all)+nrow(stevia.family.tv.simper.kw)),] <- stevia.family.tv.simper.kw
stevia.family.simper.all$fdr_krusk_p.val <- p.adjust(stevia.family.simper.all$krusk_p.val, "BH")
#write.table(stevia.family.simper.all, "stevia.family.simper.all.csv", sep=",")
```
...
# All
simper.pretty(data.frame(otu_table(phy99)),
              data.frame(sample_data(phy99)),
              c("Treatment", "Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.phylum')
stevia.simper <- read.csv("stevia.phylum_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(phy99)),
               data.frame(sample_data(phy99)),
               csv = stevia.simper,
               c("Treatment", "Time", "Sex"),
               output_name = 'stevia.phylum',
               taxonomy = data.frame(tax_table(phy99)))
stevia.simper.kw <- read.csv("stevia.phylum_krusk_simper.csv")
for(i in 1:nrow(stevia.simper.kw)){
  save <- which(rownames(data.frame(tax_table(phy99))) == stevia.simper.kw$OTU[i])
  stevia.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(phy99))[i,2], "-",
          data.frame(tax_table(phy99))[i,3], "-",
          data.frame(tax_table(phy99))[i,4], "-",
          data.frame(tax_table(phy99))[i,5], "-",
          data.frame(tax_table(phy99))[i,6])
}
#write.table(stevia.simper.kw, "stevia.phylum_krusk_simper.csv", sep=",")

# Pre-treatment
simper.pretty(data.frame(otu_table(subset_samples(phy99, Time == "Pre-treatment"))),
              data.frame(sample_data(subset_samples(phy99, Time == "Pre-treatment"))),
              c("Treatment", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.phylum.pre')
stevia.phylum.pre.simper <- read.csv("stevia.phylum.pre_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(phy99, Time == "Pre-treatment"))),
               data.frame(sample_data(subset_samples(phy99, Time == "Pre-treatment"))),
               csv = stevia.phylum.pre.simper,
               c("Treatment", "Sex"),
               output_name = 'stevia.phylum.pre',
               taxonomy = data.frame(tax_table(physeq.pre)))
stevia.phylum.pre.simper.kw <- read.csv("stevia.phylum.pre_krusk_simper.csv")
for(i in 1:nrow(stevia.phylum.pre.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(phy99, Time == "Pre-treatment")))) == stevia.phylum.pre.simper.kw$OTU[i])
  stevia.phylum.pre.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(physeq.pre))[i,2], "-",
          data.frame(tax_table(physeq.pre))[i,3], "-",
          data.frame(tax_table(physeq.pre))[i,4], "-",
          data.frame(tax_table(physeq.pre))[i,5], "-",
...
#write.table(stevia.phylum.pre.simper.kw, "stevia.phylum.pre_krusk_simper.csv", sep=",")

# Post-treatment
simper.pretty(data.frame(otu_table(subset_samples(phy99, Time == "Post-treatment"))),
              data.frame(sample_data(subset_samples(phy99, Time == "Post-treatment"))),
              c("Treatment", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.phylum.post')
stevia.phylum.post.simper <- read.csv("stevia.phylum.post_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(phy99, Time == "Post-treatment"))),
               data.frame(sample_data(subset_samples(phy99, Time == "Post-treatment"))),
               csv = stevia.phylum.post.simper,
               c("Treatment", "Sex"),
               output_name = 'stevia.phylum.post',
               taxonomy = data.frame(tax_table(subset_samples(phy99, Time == "Post-treatment"))))
stevia.phylum.post.simper.kw <- read.csv("stevia.phylum.post_krusk_simper.csv")
for(i in 1:nrow(stevia.phylum.post.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(phy99, Time == "Post-treatment")))) == stevia.phylum.post.simper.kw$OTU[i])
  stevia.phylum.post.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(physeq.post))[i,2], "-",
          data.frame(tax_table(physeq.post))[i,3], "-",
          data.frame(tax_table(physeq.post))[i,4], "-",
          data.frame(tax_table(physeq.post))[i,5], "-",
...
#write.table(stevia.phylum.post.simper.kw, "stevia.phylum.post_krusk_simper.csv", sep=",")

# High Fat
simper.pretty(data.frame(otu_table(subset_samples(phy99, Treatment == "High Fat"))),
              data.frame(sample_data(subset_samples(phy99, Treatment == "High Fat"))),
              c("Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.phylum.hf')
stevia.phylum.hf.simper <- read.csv("stevia.phylum.hf_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(phy99, Treatment == "High Fat"))),
               data.frame(sample_data(subset_samples(phy99, Treatment == "High Fat"))),
               csv = stevia.phylum.hf.simper,
               c("Time", "Sex"),
               output_name = 'stevia.phylum.hf',
               taxonomy = data.frame(tax_table(subset_samples(phy99, Treatment == "High Fat"))))
stevia.phylum.hf.simper.kw <- read.csv("stevia.phylum.hf_krusk_simper.csv")
for(i in 1:nrow(stevia.phylum.hf.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(phy99, Treatment == "High Fat")))) == stevia.phylum.hf.simper.kw$OTU[i])
  stevia.phylum.hf.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(phy99, Treatment == "High Fat")))[i,2], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "High Fat")))[i,3], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "High Fat")))[i,4], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "High Fat")))[i,5], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "High Fat")))[i,6])
}
#write.table(stevia.phylum.hf.simper.kw, "stevia.phylum.hf_krusk_simper.csv", sep=",")

# Low Fat
simper.pretty(data.frame(otu_table(subset_samples(phy99, Treatment == "Low Fat"))),
              data.frame(sample_data(subset_samples(phy99, Treatment == "Low Fat"))),
              c("Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.phylum.lf')
stevia.phylum.lf.simper <- read.csv("stevia.phylum.lf_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(phy99, Treatment == "Low Fat"))),
               data.frame(sample_data(subset_samples(phy99, Treatment == "Low Fat"))),
               csv = stevia.phylum.lf.simper,
               c("Time", "Sex"),
               output_name = 'stevia.phylum.lf',
               taxonomy = data.frame(tax_table(subset_samples(phy99, Treatment == "Low Fat"))))
stevia.phylum.lf.simper.kw <- read.csv("stevia.phylum.lf_krusk_simper.csv")
for(i in 1:nrow(stevia.phylum.lf.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(phy99, Treatment == "Low Fat")))) == stevia.phylum.lf.simper.kw$OTU[i])
  stevia.phylum.lf.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(phy99, Treatment == "Low Fat")))[i,2], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "Low Fat")))[i,3], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "Low Fat")))[i,4], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "Low Fat")))[i,5], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "Low Fat")))[i,6])
}
#write.table(stevia.phylum.lf.simper.kw, "stevia.phylum.lf_krusk_simper.csv", sep=",")

# Saccharin
simper.pretty(data.frame(otu_table(subset_samples(phy99, Treatment == "Saccharin"))),
              data.frame(sample_data(subset_samples(phy99, Treatment == "Saccharin"))),
              c("Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.phylum.sc')
stevia.phylum.sc.simper <- read.csv("stevia.phylum.sc_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(phy99, Treatment == "Saccharin"))),
               data.frame(sample_data(subset_samples(phy99, Treatment == "Saccharin"))),
               csv = stevia.phylum.sc.simper,
               c("Time", "Sex"),
               output_name = 'stevia.phylum.sc',
               taxonomy = data.frame(tax_table(subset_samples(phy99, Treatment == "Saccharin"))))
stevia.phylum.sc.simper.kw <- read.csv("stevia.phylum.sc_krusk_simper.csv")
for(i in 1:nrow(stevia.phylum.sc.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(phy99, Treatment == "Saccharin")))) == stevia.phylum.sc.simper.kw$OTU[i])
  stevia.phylum.sc.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(phy99, Treatment == "Saccharin")))[i,2], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "Saccharin")))[i,3], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "Saccharin")))[i,4], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "Saccharin")))[i,5], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "Saccharin")))[i,6])
}
#write.table(stevia.phylum.sc.simper.kw, "stevia.phylum.sc_krusk_simper.csv", sep=",")

# Stevia
simper.pretty(data.frame(otu_table(subset_samples(phy99, Treatment == "Stevia"))),
              data.frame(sample_data(subset_samples(phy99, Treatment == "Stevia"))),
              c("Time", "Sex"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='stevia.phylum.tv')
stevia.phylum.tv.simper <- read.csv("stevia.phylum.tv_clean_simper.csv")
kruskal.pretty(data.frame(otu_table(subset_samples(phy99, Treatment == "Stevia"))),
               data.frame(sample_data(subset_samples(phy99, Treatment == "Stevia"))),
               csv = stevia.phylum.tv.simper,
               c("Time", "Sex"),
               output_name = 'stevia.phylum.tv',
               taxonomy = data.frame(tax_table(subset_samples(phy99, Treatment == "Stevia"))))
stevia.phylum.tv.simper.kw <- read.csv("stevia.phylum.tv_krusk_simper.csv")
for(i in 1:nrow(stevia.phylum.tv.simper.kw)){
  save <- which(rownames(data.frame(tax_table(subset_samples(phy99, Treatment == "Stevia")))) == stevia.phylum.tv.simper.kw$OTU[i])
  stevia.phylum.tv.simper.kw$Taxonomy[i] <-
    paste(data.frame(tax_table(subset_samples(phy99, Treatment == "Stevia")))[i,2], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "Stevia")))[i,3], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "Stevia")))[i,4], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "Stevia")))[i,5], "-",
          data.frame(tax_table(subset_samples(phy99, Treatment == "Stevia")))[i,6])
}
#write.table(stevia.phylum.tv.simper.kw, "stevia.phylum.tv_krusk_simper.csv", sep=",")
```
### Jaccard NMDS
```{r}
