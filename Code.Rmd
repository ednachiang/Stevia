...
time.fem.hm <- plot_heatmap(physeq.simper.time.fem, sample.label = "Treatment_Time", 
                            ...
                            taxa.label = "OTU_Classification", taxa.order = "Phylum", low = "#FFFFCC", 
                            high = "firebrick3", na.value = "#FFFFFC") +
  geom_tile(colour="gray40") +
  #geom_text(aes(label=sprintf("%0.2f", round(Abundance, digits=2)))) +
  scale_fill_gradient(name="Relative Abundance (%)", low = "#FFFFCC", high = "firebrick3", limits=c(0,23.5)) +
