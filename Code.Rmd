...
### Within-Treatment Within-Sex Time Comparisons

### Low Fat Female
lf.fem.sampdf <- data.frame(sample_data(physeq.lf.fem))
lf.fem.bray <- phyloseq::distance(physeq=physeq.lf.fem, method="bray")

# Time
adonis(lf.fem.bray ~ Time, data=lf.fem.sampdf)
  # p-value = 0.009
  # R2 = 0.31507
beta.tax = betadisper(d=lf.fem.bray, group=lf.fem.sampdf$Time)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.105
...
### Low Fat Male
lf.mal.sampdf <- data.frame(sample_data(physeq.lf.mal))
lf.mal.bray <- phyloseq::distance(physeq=physeq.lf.mal, method="bray")

# Time
adonis(lf.mal.bray ~ Time, data=lf.mal.sampdf)
  # p-value = 0.016
  # R2 = 0.29349
beta.tax = betadisper(d=lf.mal.bray, group=lf.mal.sampdf$Time)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.068
...
### High Fat Female
hf.fem.sampdf <- data.frame(sample_data(physeq.hf.fem))
hf.fem.bray <- phyloseq::distance(physeq=physeq.hf.fem, method="bray")

# Time
adonis(hf.fem.bray ~ Time, data=hf.fem.sampdf)
  # p-value = 0.019
  # R2 = 0.67693
beta.tax = betadisper(d=hf.fem.bray, group=hf.fem.sampdf$Time)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.386
...
### High Fat Male
hf.mal.sampdf <- data.frame(sample_data(physeq.hf.mal))
hf.mal.bray <- phyloseq::distance(physeq=physeq.hf.mal, method="bray")

# Time
adonis(hf.mal.bray ~ Time, data=hf.mal.sampdf)
  # p-value = 0.012
  # R2 = 0.59587
beta.tax = betadisper(d=hf.mal.bray, group=hf.mal.sampdf$Time)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.358
...
### Saccharin Female
sc.fem.sampdf <- data.frame(sample_data(physeq.sc.fem))
sc.fem.bray <- phyloseq::distance(physeq=physeq.sc.fem, method="bray")

# Time
adonis(sc.fem.bray ~ Time, data=sc.fem.sampdf)
  # p-value = 0.01
  # R2 = 0.61226
beta.tax = betadisper(d=sc.fem.bray, group=sc.fem.sampdf$Time)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.337
...
### Saccharin Male
sc.mal.sampdf <- data.frame(sample_data(physeq.sc.mal))
sc.mal.bray <- phyloseq::distance(physeq=physeq.sc.mal, method="bray")

# Time
adonis(sc.mal.bray ~ Time, data=sc.mal.sampdf)
  # p-value = 0.036
  # R2 = 0.55684
beta.tax = betadisper(d=sc.mal.bray, group=sc.mal.sampdf$Time)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.645
...
### Stevia Female
tv.fem.sampdf <- data.frame(sample_data(physeq.tv.fem))
tv.fem.bray <- phyloseq::distance(physeq=physeq.tv.fem, method="bray")

# Time
adonis(tv.fem.bray ~ Time, data=tv.fem.sampdf)
  # p-value = 0.017
  # R2 = 0.72228
beta.tax = betadisper(d=tv.fem.bray, group=tv.fem.sampdf$Time)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.712
...
### Stevia Male
tv.mal.sampdf <- data.frame(sample_data(physeq.tv.mal))
tv.mal.bray <- phyloseq::distance(physeq=physeq.tv.mal, method="bray")

# Time
adonis(tv.mal.bray ~ Time, data=tv.mal.sampdf)
  # p-value = 0.033
  # R2 = 0.63093
beta.tax = betadisper(d=tv.mal.bray, group=tv.mal.sampdf$Time)
p <- permutest(beta.tax)
p$tab
  # p-value = 0.842
