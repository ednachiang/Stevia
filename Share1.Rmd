...
Visually (not statistically tested yet), there are shifts in Pre-treatment vs. Post-treatment.  
Within Post-treatment samples, Low Fat seems to be the most different compared to all other treatments. Namely, Low Fat has a higher relative abundance of Bacteroidetes and lower relative abundance of Verrucomicrobia.  
...
Sex-related trends that caught my eye (not statistically tested yet):  
...
All the identified OTUs within 1 pairwise comparison (Low Fat vs. 1 treatment) are found in at least 1 other pairwise comparison (Low Fat vs. another treatment).  
```{r, echo=F}
