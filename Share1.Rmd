...
* Within-sample diversity (alpha):
    + Driven by presence/absence of OTUs rather than their relative abundances
    + Within Post-treatment samples, Low Fat has higher richness (# unique OTUs) compared to High Fat and Saccharin
* Between-sample diversity (beta):
    + For each treatment, Pre- and Post- samples are different
    + Pre-treatment samples:
      - Female vs. Male samples are different
    + Post-treatment samples:
        - Low Fat is different from all other treatments (High Fat, Saccharin, Stevia)
        - Saccharin vs. Stevia trend towards a difference
            - Trend seen within Females but not Males
* Important OTUs (contribute the most to variation in between-sample diversity):
    + Post-treatment:
        - Majority of OTUs found between Low Fat vs. other treatments
        - High Fat vs. Saccharin:
            - 1 unclassified Lachnospiraceae
        - Saccharin vs. Stevia:
            - 1 Lachnoclostridium
    + OTUs were identified within each treatment for Pre vs. Post
    + OTUs were identified within Pre-treatment for Female vs. Male
...
To determine to what extent the categorical factors are contributing to between-sample differences, I used PERMANOVA to evaluate:  
